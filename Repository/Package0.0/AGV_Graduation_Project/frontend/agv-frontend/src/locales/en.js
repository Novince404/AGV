export default {
  ...
  "settings": {
    ...
    "resizeGroupHint": "Before we allow real map size editing, run a dry precheck here to see whether tasks, AGVs, points, templates, or blocked cells would block the change.",
