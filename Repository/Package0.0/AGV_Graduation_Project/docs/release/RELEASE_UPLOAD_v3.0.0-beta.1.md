...
1. `frontend/agv-frontend/package.json` 与 `package-lock.json` 的项目版本均为 `3.0.0-beta.1`。
...
gh release create v3.0.0-beta.1 `
  ...
  --notes-file "Repository/Package0.0/AGV_Graduation_Project/docs/release/RELEASE_DRAFT_v3.0.0-beta.1.md" `
  --prerelease
```
