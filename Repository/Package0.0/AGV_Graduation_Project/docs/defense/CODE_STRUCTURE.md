...
| 前端主应用 | `frontend/agv-frontend/src/App.vue` | 全局状态、地图交互、任务导入、调度触发、企业设置、AI 工作台挂载。 |
| 前端组件 | `frontend/agv-frontend/src/components/` | 地图设置、ComfyAI 工作台、登录弹窗、企业审批、反馈等组件。 |
| 前端样式 | `frontend/agv-frontend/src/assets/` | 地图、站点、弹窗、布局等样式。 |
| 多语言文案 | `frontend/agv-frontend/src/locales/` | 中文、英文、日文 UI 文案。 |
