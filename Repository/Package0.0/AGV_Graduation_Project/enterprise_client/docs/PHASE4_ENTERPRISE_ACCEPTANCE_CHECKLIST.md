...
当前状态：`[前端基础链已补，仍建议演示复核]` 后端容量、电量趋势、充满释放等核心链已补回归；运行态站级显示已补 `P/C + n/m`、悬停 AGV 编号和键盘可访问入口，站内列表观感仍可继续精修。
...
当前状态：`[前端基础链已补，仍建议演示复核]` 已补首次进入后自动打开、`H` 重开、顶层弹窗承载和回仓回充说明内容；仍建议在完整演示链中人工复核一次。
