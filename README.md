...
项目已经通过毕业设计答辩。`v2.0.0` 保留为最低可交付稳定版，当前产品化主线进入 `v3.0.0-beta.1` 预发布阶段。
...
- 最新稳定标签：`v2.0.0`
- 最新预发布版本：[`v3.0.0-beta.1`](https://github.com/Novince404/AGV/releases/tag/v3.0.0-beta.1)
- 当前主线：`3.x` 产品化 Beta，重点覆盖登录与角色治理、企业数据隔离、企业路网、连续运动、动态避让和独立客户端
