...
# SQL stores load tenant data only after the lifecycle has verified the
# Alembic revision. Do not perform that load while modules are imported.
agv_list = getattr(_store, "agv_list", [])
